...
{{
    "query": "培训",
    "filter": "and(eq(\\"城市\",\\"广州\\"),like(\\"地区\\",\\"琶洲\\"),gte(\\"最大容纳人数\\",100),lte(\"会场全天价格\",10000))" 
}}
```\
"""
...
{{
    "query": "讲座",
    "filter": "and(eq(\\"城市\",\\"广州\\"),like(\\"地区\\",\\"东山口\\"),gte(\\"最大容纳人数\\",200),lte(\"会场全天价格\",5000))" 
}}
```\
"""
...
{{
    "query": "培训",
    "filter": "and(eq(\\"城市\",\\"广州\\"),gte(\\"最大容纳人数\\",100),lte(\"会场全天价格\",10000))" 
}}
```\
"""
...
{{
    "query": "讲座",
    "filter": "and(eq(\\"城市\",\\"广州\\"),gte(\\"最大容纳人数\\",200),lte(\"会场全天价格\",5000))" 
}}
```\
"""
...
OPENSEARCH_HOTEL_EXAMPLES = [
    {
        "i": 1,
        "data_source": HOTEL_DATA_SOURCE,
        "user_query": "广州琶洲有哪个酒店可以举办100人培训？预算1万",
        "structured_request": OPENSEARCH_FULL_ANSWER,
    },
    {
        "i": 2,
        "data_source": HOTEL_DATA_SOURCE,
        "user_query": "广州东山口举办200人讲座？2天时间，预算1万",
        "structured_request": OPENSEARCH_FULL_ANSWER2,
    },
    {
        "i": 3,
        "data_source": HOTEL_DATA_SOURCE,
...
def get_examples(database):
    if database == 'opensearch':
        return OPENSEARCH_HOTEL_EXAMPLES
    else:
        return HOTEL_EXAMPLES