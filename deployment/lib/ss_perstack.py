...
class PersonalizeStack(Stack):
    ...
    # configure the lambda role
        ...
        personalize_role.add_to_policy(_personalize_role_policy)

        personalize_role.add_managed_policy(
        ...
        qa_api = apigw.RestApi(self, 'personalize-api',
        ...
        # personalize_function.add_environment("user_table_name", user_table.table_name)