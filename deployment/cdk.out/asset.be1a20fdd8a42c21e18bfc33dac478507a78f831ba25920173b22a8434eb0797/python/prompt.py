...
CLAUDE_ENGLISH_CHAT = """Human:You are an assistant, Refer to the following conversation history to answer questions from users.
...
CLAUDE_ENGLISH_SUMMARIZE = """Human:According to the user's problem, summarize the customer's needs from various dimensions.
